...
/**
 * REST controller for managing Pageconciertos.
 */
@RestController
@RequestMapping("/api/pageconciertos")
public class PageconciertosResource {

    private final Logger log = LoggerFactory.getLogger(PageconciertosResource.class);
