...
/**
 * REST controller for managing Pageregister.
 */
@RestController
@RequestMapping("/api/pageregister")
public class PageregisterResource {

    private final Logger log = LoggerFactory.getLogger(PageregisterResource.class);
