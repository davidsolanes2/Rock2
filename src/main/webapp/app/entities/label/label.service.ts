...
export class LabelService {
    ...
    private convertItemFromServer(json: any): Label {
        ...
        entity.foundationdate = this.dateUtils
            .convertLocalDateFromServer(json.foundationdate);
        return entity;
    }
    ...
    private convert(label: Label): Label {
        ...
        copy.foundationdate = this.dateUtils
            .convertLocalDateToServer(label.foundationdate);
        return copy;
    }
}
